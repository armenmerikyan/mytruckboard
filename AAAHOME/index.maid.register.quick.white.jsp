...
System.out.println("TEST LINE MADE IT ");
					...
					if(request.getParameter("email")!=null && !request.getParameter("email").equals("") && request.getParameter("password")!=null && !request.getParameter("password").equals("") && request.getParameter("ReEnterPassword")!=null && !request.getParameter("ReEnterPassword").equals("")&& request.getParameter("phone")!=null && !request.getParameter("phone").equals("") && request.getParameter("company_name")!=null && !request.getParameter("company_name").equals("")){
						if(request.getParameter("term_of_service") == null || !request.getParameter("term_of_service").equals("Yes")){
							...
							ps.executeUpdate();
							errorMsg = "Your Account Was Created<BR>Use <a href=\"index.jsp\" class=\"scrolly\">MaidsApp.com</a> Login Form To Access Your Account.";					
							connection.close();
				...
				<header>
                    <div class="content style4 featured">
                        <div class="container small">
                            <FORM id="formMain" name="formMain" action="https://www.mytruckboard.com/AAAHOME/index.maid.register.jsp" method="post">
                    ...
                    <div class="row half">
                    	...
                    	<%if(errorMsg!=null && !errorMsg.equals("")){%>
                            ...
                            <br>
                        <%}else{%>
                        <h2>Maid Services Inc</h2>Jobs Application
                            <br>
                         <%}%>   
                    </div>     
                    </div>                             
                                <div class="row half">
                                    <div class="12u">
                                    One Step Sign-up makes Signing up easy, and you'll be earning more work and money in no time.
                                    Once your application is submitted we will contact you directly with detail instruction of next steps.  
                                    </div>
                                </div>
                                <div class="row half">
