...
================================================== -->
 ...
 <%
			...
			PreparedStatement ps = connection.prepareStatement("update maids_oltp.litem_board set isonline = 1 where messageid = ?");
			if(request.getParameter("messageID")!=null){
			ps = connection.prepareStatement("update maids_oltp.litem_board where messageid = ?");
			ps.setString(1,request.getParameter("messageID"));
			ps.executeUpdate();
			}
			ps = connection.prepareStatement("select * from maids_oltp.litem_board order by ts desc limit 100");
...
%>
      ...
      <p>
          <a href="basicbt.Admin.jsp?messageID=<%=resultSet.getString("messageId")%>" ><img class="img-circle" src="http://www.liteworks2.com/litem/getImageServiceLow.jsp?CLIENT_ID=<%=resultSet.getString("messageId")%>" alt="Generic placeholder image" width="140" height="140"></a>
      </p>
