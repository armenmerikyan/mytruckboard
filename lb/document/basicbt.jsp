...
================================================== -->
  <body>
    <div class="navbar-wrapper">
      <div class="container">
		...
		<li>
		<a href="about.jsp" ><span id="Gtotal" name="Gtotal" >About</span></a> 
                </li>
		<li>
		<a href="https://angel.co/liteworks2" ><span id="Gtotal" name="Gtotal" >Investors</span></a> 
                </li>
              </ul>
            </div>            
          </div>
 ...
 <%
			...
			PreparedStatement ps = connection.prepareStatement("select * from maids_oltp.litem_board where isOnline = 1 order by ts desc limit 100");
		...
		&& request.getParameter("fromField")!=null && !request.getParameter("fromField").equals("")
			...
			ps = connection.prepareStatement("select * from litem_board where isOnline = 1  and toField = ? and fromField = ? order by ts desc limit 100");
		...
		&& (request.getParameter("fromField")==null || request.getParameter("fromField").equals(""))
			...
			ps = connection.prepareStatement("select * from litem_board where isOnline = 1  and toField = ? order by ts desc limit 100");
			ps.setString(1,request.getParameter("toField"));
		}
		if((request.getParameter("toField")==null || request.getParameter("toField").equals(""))
		&& request.getParameter("fromField")!=null && !request.getParameter("fromField").equals("")
		){
			ps = connection.prepareStatement("select * from litem_board where isOnline = 1  and fromField = ? order by ts desc limit 100");
