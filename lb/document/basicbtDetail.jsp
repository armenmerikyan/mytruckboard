...
================================================== -->
 ...
 <%
			...
			PreparedStatement ps = connection.prepareStatement("select * from maids_oltp.litem_board where messageId = ? order by ts desc limit 100");
...
%>      		
      ...
      <p> 
          <a href="basicbtDetail.jsp" ><img class="img-circle" src="http://www.liteworks2.com/litem/getImageService.jsp?CLIENT_ID=<%=resultSet.getString("messageId")%>" alt="Generic placeholder image" width="1080" height="1080"></a>
      </p>    
