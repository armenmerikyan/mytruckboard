	...
	<script type="text/javascript">
      ...
      function clearFieldsNowCity() {
        ...
        function viewInvoicePayments(load_id) {
					...
					responseString = responseString + "&new_fin_type=" + encodeURIComponent("Manager Bonus Payment");		
		...
		<%
			...
			while (resultSet.next()) {
				...
				if(!resultSetMap.containsKey(resultSet.getString("load_board_id"))){
					if((resultSet.getString("managerID")!=null && resultSet.getString("managerID").contains((String)session.getAttribute("login_id")))
					){
					...
					rowArray[6] = resultSet.getString("managerID");
