...
<body  onload="initialize()">
    ...
    <li ><a href="http://iwanttomoveit.com">FREIGHT QUOTE</a></li>
...
<c:forEach var="row" items="${rs.rows}">
				...
				<a href="javascript:;" onclick="getDetail('${row.key_public}')">	${row.f_name}, ${row.l_name}</a></td> 
				<td style="padding:5px;border-width:1px 0px 1px 0px;">
				${row.company_name}
				</td>  
				<td style="padding:5px;border-width:1px 0px 1px 0px;">
	...
	%> 				
				<td style="padding:5px;border-width:1px 0px 1px 0px;"><%=current_truck_type[currentTruckType]%></td> 				
				<td style="padding:5px;border-width:1px 0px 1px 0px;"><%=driver_state[currentState]%></td>    
				...
				<td style="padding:5px;border-width:1px 0px 1px 0px;text-align:right;">
  				...
  				<%}%>
				<td style="padding:5px;border-width:1px 0px 1px 0px;text-align:right;">
				<fmt:formatNumber type="currency" maxFractionDigits="2" value="${row.price_per_mile}"/></td>    
				<td style="padding:5px;border-width:1px 0px 1px 0px;text-align:right;">
