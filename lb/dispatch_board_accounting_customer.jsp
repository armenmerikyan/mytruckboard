...
<div class="modal fade" id="myModalInv" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <input type="text" class="form-control"  aria-describedby="basic-addon1"  name="new_invoice_payment_amount" id="new_invoice_payment_amount" value="" placeholder="">
	...
	<a href="dispatch_board_accounting_customer.jsp?searchType=LoadStatus&searchKey=Delivered&ShowSearchAccountingCustomer=true">
					...
					<a href="dispatch_board_accounting_customer.jsp?searchType=LoadStatus&searchKey=Complete&ShowSearchAccountingCustomer=true">
					<div class="col-lg-3 col-md-3 col-sm-3 col-sx-6">
					<div class="panel panel-primary">
					...
					<a href="dispatch_board_accounting_customer.jsp?searchType=LoadStatus&searchKey=Invoiced&ShowSearchAccountingCustomer=true">
					<div class="col-lg-3 col-md-3 col-sm-3 col-sx-6">
					<div class="panel panel-primary">
					...
					<a href="dispatch_board_accounting_customer.jsp?searchType=LoadStatus&searchKey=Paid&ShowSearchAccountingCustomer=true">
					<div class="col-lg-3 col-md-3 col-sm-3 col-sx-6">
					<div class="panel panel-primary">
	...
	<tbody style="font-size:13px;">
		...
		<%
			...
			<td style="padding:5px;"><%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[18])%></td>
			<td style="padding:5px;">&nbsp;</td>
			<td style="padding:5px;"><%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[15])%></td>
			...
			<td  style="padding:5px;width:100px;"><span onclick="showInvoicePrint('<%=((String[])resultSetMap.get((String)resultSetVector.get(l)))[0]%>', '<%=((String[])resultSetMap.get((String)resultSetVector.get(l)))[1]%>','Invoice Payments')" class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></span></td>
			<td style="padding:5px;">
	<select name="select<%=((String[])resultSetMap.get((String)resultSetVector.get(l)))[0]%>" id="select<%=((String[])resultSetMap.get((String)resultSetVector.get(l)))[0]%>" onchange="updateLoadStatus('<%=((String[])resultSetMap.get((String)resultSetVector.get(l)))[0]%>',this.value)" >
        ...
        <option <%if(NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[13]).equals("Delivered")){%>selected<%}%> value="Delivered" name="load_status_label" id="load_status_label">Delivered</option>	
        ...
        <option <%if(NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[13]).equals("Invoiced")){%>selected<%}%> value="Invoiced" name="load_status_label" id="load_status_label">Invoiced</option>			
        <option <%if(NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[13]).equals("Paid")){%>selected<%}%> value="Paid" name="load_status_label" id="load_status_label">Paid</option>			
	</select>		
			</td>
			</tr>				
