...
%>
	...
	<div class="row">
<br/><br/><br/><br/>
	<form  name="searchForm" id="searchForm" action="dispatch_edit_customsbrokers.jsp" method="post">	    
	...
	<a href="dispatch_customsbrokers.jsp?ShowSearchCustoms=true" style="color:white"><span class="glyphicon glyphicon-backward" aria-hidden="true" style="color:white" ></span>&nbsp;BACK</a>&nbsp;&nbsp;
