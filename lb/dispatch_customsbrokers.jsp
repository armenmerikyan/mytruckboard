<%@ page import="com.big.util.*,java.text.*,java.util.*,java.io.*,javax.xml.parsers.*,org.w3c.dom.*,java.sql.*,java.text.DateFormat" %>
	...
	<title>MYTRUCKBOARD 2.0 - dispatch consignee list</title>
    ...
    <script language="JavaScript" type="text/javascript">
            function openCustomerDetail(load_id){
            	window.location.replace("dispatch_edit_customsbrokers.jsp?location_id="+ load_id);
            }
   </script>
...
%>
	...
	<table class="table table-hover table-bordered tablesorter" id="boardtable2">
...
%>
			...
			<td><%=resultSet.getString("org_phone")%></td>
