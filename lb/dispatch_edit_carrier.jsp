	...
	<%if(request.getParameter("location_id")!=null || request.getParameter("cmd")!=null){
		 try{
			...
			if(request.getParameter("cmd")!=null && request.getParameter("cmd").equals("addLocation")){
					...
					ps.setString(36, request.getParameter("ins_name"));
					ps.setString(37, request.getParameter("ins_contact"));
					ps.setString(38, request.getParameter("ins_phone"));
					ps.setString(39, request.getParameter("ins_policy_no"));
					ps.setTimestamp(40, date_mod);
					ps.setFloat(41, saveins_amount);
					ps.setString(42, request.getParameter("ins_name_auto"));
					ps.setString(43, request.getParameter("ins_contact_auto"));
					ps.setString(44, request.getParameter("ins_phone_auto"));
					ps.setString(45, request.getParameter("ins_policy_no_auto"));
					ps.setTimestamp(46, date_mod_auto);
					ps.setFloat(47, saveins_amount_auto);
					ps.setString(48, request.getParameter("ins_name_cargo"));
					ps.setString(49, request.getParameter("ins_contact_cargo"));
					ps.setString(50, request.getParameter("ins_phone_cargo"));
					ps.setString(51, request.getParameter("ins_policy_no_cargo"));
					ps.setTimestamp(52, date_mod_cargo);
					ps.setFloat(53, saveins_amount_cargo);
					ps.setString(54, request.getParameter("ins_notes"));
					ps.setString(55, request.getParameter("contact_passwd"));
			...
			if(request.getParameter("cmd")!=null && request.getParameter("cmd").equals("saveLocation")){	
					...
					ps.setString(29, request.getParameter("ins_name"));
					ps.setString(30, request.getParameter("ins_contact"));
					ps.setString(31, request.getParameter("ins_phone"));
					ps.setString(32, request.getParameter("ins_policy_no"));
					ps.setTimestamp(33, date_mod);
					ps.setFloat(34, saveins_amount);
					ps.setString(35, request.getParameter("ins_name_auto"));
					ps.setString(36, request.getParameter("ins_contact_auto"));
					ps.setString(37, request.getParameter("ins_phone_auto"));
					ps.setString(38, request.getParameter("ins_policy_no_auto"));
					ps.setTimestamp(39, date_mod_auto);
					ps.setFloat(40, saveins_amount_auto);
					ps.setString(41, request.getParameter("ins_name_cargo"));
					ps.setString(42, request.getParameter("ins_contact_cargo"));
					ps.setString(43, request.getParameter("ins_phone_cargo"));
					ps.setString(44, request.getParameter("ins_policy_no_cargo"));
					ps.setTimestamp(45, date_mod_cargo);
					ps.setFloat(46, saveins_amount_cargo);
					ps.setString(47, request.getParameter("ins_notes"));
					ps.setString(48, request.getParameter("contact_passwd"));					
					ps.setString(49, uuid);
					ps.setString(50, request.getParameter("location_id"));
					ps.executeUpdate();				
			}
			
			ps = connection.prepareStatement("select password, ins_notes, ins_name_cargo, ins_contact_cargo, ins_phone_cargo, ins_policy_no_cargo, ins_exp_date_cargo, ins_amount_cargo, ins_name_auto, ins_contact_auto, ins_phone_auto, ins_policy_no_auto, ins_exp_date_auto, ins_amount_auto, ins_name, ins_contact, ins_phone, ins_policy_no, ins_exp_date, ins_amount, dot_number, isCorporation, location_number, isFactoring, bond_insurance, ein_number, notes_admin, web_site_url, org_phone_second, org_fax, org_name, org_phone, address, city, state, zip, contact_name, contact_phone, contact_email, org_email, notes, sales_rep, mc_number, urs_number, isBlackListed, isActive, isBroker, credit_limit, payment_terms, X(addressLocation) as city_lat, Y(addressLocation) as city_lng from test.locations where company_id = ? and location_id = ?");
			ps.setString(1, uuid);
			ps.setString(2, location_id);
			...
			while (resultSetShow.next()) {
				...
				contact_passwd = resultSetShow.getString("password");
...
<br/><br/><br/><br/>
	...
	<a href="dispatch_carriers.jsp?isActive=true&searchKey=&ShowSearchCarriers=true" style="color:white"><span class="glyphicon glyphicon-backward" aria-hidden="true" style="color:white" ></span>&nbsp;BACK</a>&nbsp;&nbsp;
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								<%}%>
								<input type="text" class="form-control" name="location_name" id="location_name"  placeholder="Best Rate Trucking, Inc." value="<%=location_name%>" />
							</div>
						</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" class="form-control"  name="org_phone" id="org_phone" value="<%=NullCheck.check(location_phone)%>"/>
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="form-group">
								<label>Address</label>
								<input type="text" class="form-control" name="address" id="address" value="<%=NullCheck.check(location_address)%>"/>
							</div>
						</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								<label>City</label>
								<input type="text" class="form-control"  name="city" id="city" value="<%=NullCheck.check(location_city)%>"/>
							</div>
						</div>
						...
						<div class="col-md-1">
							<div class="form-group">
								<label>State</label>
								<input type="text" class="form-control"  name="state" id="state" value="<%=NullCheck.check(location_state)%>"/>
							</div>
						</div>
						...
						<div class="col-md-1">
							<div class="form-group">
								...
								<input type="text" class="form-control"  name="zip" id="zip"  value="<%=NullCheck.check(location_zip)%>"/>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input readonly onfocus="this.removeAttribute('readonly');" type="text" class="form-control"  name="contact_passwd" id="contact_passwd"  placeholder="" value="<%=NullCheck.check(contact_passwd)%>" />
							</div>
						</div>
			...
			<div class="form-wrapper">
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<label>D.O.T.</label>
							<input type="text" class="form-control" name="dot_number" id="dot_number"  placeholder="" value="<%=NullCheck.check(dot_number)%>" />
						</div>
					</div>
				...
				<div class="form-wrapper">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label>Notes</label>
									<textarea rows="2" class="form-control" style="color:green;" name="ins_notes" id="ins_notes"  placeholder="" value="<%=ins_notes%>"></textarea>
								</div>
							</div>
						</div>
				</div>
			...
			<div class="form-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label>Notes</label>
								<textarea class="form-control" rows="3" name="note" id="note"  placeholder="notes....." ><%=NullCheck.check(location_note)%></textarea>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" rows="3" name="note_admin" id="note_admin"  placeholder="Admin notes....." ><%=NullCheck.check(location_note_admin)%></textarea>
							</div>
