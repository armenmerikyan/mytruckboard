...
//			String url = "jdbc:sapdb://localhost/BIGDB?sqlmode=ORACLE";
		...
		Connection connection2 = DriverManager.getConnection(url,"<USERNAME>", "<PASSWORD>");
			...
			String nameAccess = "";
			String emailAcess = "";
			ps = connection.prepareStatement("update mtb_approved_location_viewer set is_approved = 1 WHERE approved_id = ? and client_id_approved = ?");	
			ps.setString(1, request.getParameter("access_id"));
			ps.setString(2, clientid);				
			System.out.println("LINE ITEM CLIENT ID EXECUTE UPDATE ACCESS : " +request.getParameter("access_id") );
			System.out.println("LINE ITEM CLIENT ID EXECUTE UPDATE ACCESS : " +clientid );
			System.out.println("LINE ITEM CLIENT ID EXECUTE UPDATE ACCESS : " +ps.executeUpdate() );
		%><%=stringResponseAll%><%
		connection.close();		     
