		 ...
		 try{
			...
			Connection connection = DriverManager.getConnection(url,"<USERNAME>", "<PASSWORD>");	
				...
				if(request.getParameter("actionType") != null && !request.getParameter("actionType").equals("") && request.getParameter("actionType").equals("addItem")){
					...
					ps = connection.prepareStatement("INSERT INTO test.trucking_quote_lineitem(line_item_id, external_id, ts, description, type, qt, length, width, height, weight, quote_id) VALUES (?,?,?,?,?,?,?,?,?,?,?)");				
				...
				if(request.getParameter("actionType") != null && !request.getParameter("actionType").equals("") && request.getParameter("actionType").equals("removeItem")){
					ps = connection.prepareStatement("delete from test.trucking_quote_lineitem where line_item_id = ?");				
