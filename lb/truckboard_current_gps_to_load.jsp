...
%>
 ...
 /*
    ...
    */
        ...
        //alert(urlString);
        xmlhttp.open("GET", "trucklist-detail_current_gps_to_load.jsp?origin=" + encodeURIComponent(startLoc) + "&lat=" + lat +"&long=" + long + urlString,true);
        xmlhttp.send();
        }
...
//  			alert('test');
  			...
  			xmlhttp.onreadystatechange=function()
				...
				search_query_detail = search_query_detail;
  				//alert("YOYO" + search_query_detail + "&resultRows=" + resultRows);	
