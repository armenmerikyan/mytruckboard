  ...
  <input type="text" class="form-control"  aria-describedby="basic-addon1"  name="new_invoice_payment_amount" id="new_invoice_payment_amount" value="" placeholder="">
	...
	<div class="container-fluid">
		...
		<%
	         try{
				...
				PreparedStatement psMain = connection.prepareStatement("select count(load_board_id) as itemCount from test.load_board WHERE load_board.COMPANY_ID = ? and load_status= 'Delivered'");
				psMain.setString(1, uuid);
				ResultSet resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					totalCountDelivered = resultSet.getInt("itemCount");
				}
				psMain = connection.prepareStatement("select count(load_board_id) as itemCount from test.load_board WHERE load_board.COMPANY_ID = ? and load_status= 'Complete'");
				psMain.setString(1, uuid);
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					totalCountCompleted = resultSet.getInt("itemCount");
				}
				psMain = connection.prepareStatement("select count(load_board_id) as itemCount from test.load_board WHERE load_board.COMPANY_ID = ? and load_status= 'Invoiced'");
				psMain.setString(1, uuid);
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					totalCountInvoiced = resultSet.getInt("itemCount");
				}
				psMain = connection.prepareStatement("select count(load_board_id) as itemCount from test.load_board WHERE load_board.COMPANY_ID = ? and load_status= 'Paid'");
				psMain.setString(1, uuid);
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
	...
	<tbody style="font-size:13px;">
		...
		<%
			...
			HashMap resultSetMapPaymentsCarrier = new HashMap();
			HashMap resultSetMapPen = new HashMap();
			HashMap resultSetMapBonusManager = new HashMap();
			HashMap resultSetMapBonusAgent = new HashMap();
			HashMap resultSetMapBonusSales = new HashMap();
			HashMap resultSetMapPaymentManager = new HashMap();
			HashMap resultSetMapPaymentAgent = new HashMap();
			HashMap resultSetMapPaymentSales = new HashMap();
			...
			while (resultSet.next()) {
				...
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Invoice Payment' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Invoice Payment' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Invoice Payment' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Invoice Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Carrier Payment' group by  load_board.load_board_id order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Carrier Payment' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Carrier Payment' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Carrier Payment' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Carrier Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapPaymentsCarrier.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}
				psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Penalty Charge' group by  load_board.load_board_id order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Penalty Charge' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Penalty Charge' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Penalty Charge' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Penalty Charge' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapPen.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}
////////////////Bonuses Pull

				psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Bonus Payment' group by  load_board.load_board_id order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Bonus Payment' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Bonus Payment' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Bonus Payment' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Bonus Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapBonusManager.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}
				...
				if(request.getParameter("searchType")!=null){
					...
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Agent Bonus Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapBonusAgent.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}

				psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Bonus Payment' group by  load_board.load_board_id order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Bonus Payment' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Bonus Payment' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Bonus Payment' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Bonus Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapBonusSales.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}
////////////////Employee Payments Pull

				psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Payment' group by  load_board.load_board_id order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Payment' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Payment' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Payment' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Manager Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapPaymentManager.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}

				psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Agent Payment' group by  load_board.load_board_id order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Agent Payment' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Agent Payment' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Agent Payment' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Agent Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapPaymentAgent.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}

				psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Payment' group by  load_board.load_board_id order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Payment' and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("load_number")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Payment' and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){
							psMain = connection.prepareStatement("select load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Payment' and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));
						
					}
					if(request.getParameter("searchType").equals("customer")){
							psMain = connection.prepareStatement("select locations.org_name, load_board.load_board_id, SUM(load_board_finance.fin_amount) as all_total_paid from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id  left join test.load_board_finance on load_board.load_board_id = load_board_finance.load_id where load_board.company_id = ? and load_board_finance.fin_type = 'Sales Payment' and locations.org_name like ?  group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, "%" + request.getParameter("searchKey") + "%");
				...
				resultSet = psMain.executeQuery();
				while (resultSet.next()) {
					resultSetMapPaymentSales.put(resultSet.getString("load_board_id"), String.format("%.02f", resultSet.getFloat("all_total_paid")));
				}
				
				psMain = connection.prepareStatement("select * from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? order by load_board.ts asc");
				psMain.setString(1, uuid);
				if(request.getParameter("searchType")!=null){
					if(request.getParameter("searchType").equals("wo_number")){						
							psMain = connection.prepareStatement("select * from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board.load_wo = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));						
					}
					if(request.getParameter("searchType").equals("load_number")){						
							psMain = connection.prepareStatement("select * from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board.load_number = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));						
					}
					if(request.getParameter("searchType").equals("LoadStatus")){						
							psMain = connection.prepareStatement("select * from test.load_board left join test.locations on load_board.bill_to_id = locations.location_id where load_board.company_id = ? and load_board.load_status = ? group by  load_board.load_board_id order by load_board.ts asc");			
							psMain.setString(1, uuid);
							psMain.setString(2, request.getParameter("searchKey"));						
					}
					if(request.getParameter("searchType").equals("customer")){		
			...
			while (resultSet.next()) {
				...
				if(!resultSetMap.containsKey(resultSet.getString("load_board_id"))){
					...
					float tmpTotalDue = ((resultSet.getFloat("load_rate") * resultSet.getFloat("load_units")) + resultSet.getFloat("load_other")) - (resultSet.getFloat("bill_to_advances") + tmpPaid);	
					float tmpTotal = ((resultSet.getFloat("load_rate") * resultSet.getFloat("load_units")) + resultSet.getFloat("load_other"));	
					rowArray[17] = String.format("%.02f", tmpTotal);
					rowArray[20] = String.format("%.02f", tmpTotalDue);
					if(resultSetMapPaymentsCarrier.containsKey(resultSet.getString("load_board_id"))){
						rowArray[19] = (String)resultSetMapPaymentsCarrier.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[19] = "0.00";	
					}
					if(resultSetMapPayments.containsKey(resultSet.getString("load_board_id"))){
						rowArray[18] = (String)resultSetMapPayments.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[18] = "0.00";	
					}
					if(resultSetMapBonusManager.containsKey(resultSet.getString("load_board_id"))){
						rowArray[25] = (String)resultSetMapBonusManager.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[25] = "0.00";	
					}
					if(resultSetMapBonusAgent.containsKey(resultSet.getString("load_board_id"))){
						rowArray[26] = (String)resultSetMapBonusAgent.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[26] = "0.00";	
					}
					if(resultSetMapBonusSales.containsKey(resultSet.getString("load_board_id"))){
						rowArray[27] = (String)resultSetMapBonusSales.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[27] = "0.00";	
					}
					if(resultSetMapPaymentManager.containsKey(resultSet.getString("load_board_id"))){
						rowArray[32] = (String)resultSetMapPaymentManager.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[32] = "0.00";	
					}
					if(resultSetMapPaymentAgent.containsKey(resultSet.getString("load_board_id"))){
						rowArray[33] = (String)resultSetMapPaymentAgent.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[33] = "0.00";	
					}
					if(resultSetMapPaymentSales.containsKey(resultSet.getString("load_board_id"))){
						rowArray[34] = (String)resultSetMapPaymentSales.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[34] = "0.00";	
					}
					float tmpTotalCarrier = 0.0f;
					float tmpTotalBonuses = 0.0f;
					float tmpTotalPaidEmp = 0.0f;
					float tmpTotalCarrierAmount = (resultSet.getFloat("carrier_rate") + resultSet.getFloat("load_carrier_fee"));
					if(resultSetMapPaymentsCarrier.containsKey(resultSet.getString("load_board_id")))tmpTotalCarrier = Float.parseFloat((String)resultSetMapPaymentsCarrier.get(resultSet.getString("load_board_id")));
					float tmpTotalCarrierDue = (resultSet.getFloat("carrier_rate") + resultSet.getFloat("load_carrier_fee")) - (resultSet.getFloat("advances_total") + tmpTotalCarrier);	
					rowArray[21] = String.format("%.02f", tmpTotalCarrierAmount);	
					rowArray[22] = String.format("%.02f", tmpTotalCarrierDue);
					
					float tmpTotalRev = ((resultSet.getFloat("load_rate") * resultSet.getFloat("load_units")) + resultSet.getFloat("load_other"));	
					float tmpGross = tmpTotalRev - tmpTotalCarrierAmount;	
					rowArray[23] = String.format("%.02f", tmpGross);
					if(resultSetMapPen.containsKey(resultSet.getString("load_board_id"))){
						rowArray[24] = (String)resultSetMapPen.get(resultSet.getString("load_board_id"));	
					}else{
						rowArray[24] = "0.00";	
					}
					tmpTotalBonuses = tmpTotalBonuses + Float.parseFloat(rowArray[25]);
					tmpTotalBonuses = tmpTotalBonuses + Float.parseFloat(rowArray[26]);
					tmpTotalBonuses = tmpTotalBonuses + Float.parseFloat(rowArray[27]);
					tmpTotalPaidEmp = tmpTotalPaidEmp + Float.parseFloat(rowArray[32]);
					tmpTotalPaidEmp = tmpTotalPaidEmp + Float.parseFloat(rowArray[33]);
					tmpTotalPaidEmp = tmpTotalPaidEmp + Float.parseFloat(rowArray[34]);
									
					rowArray[28] = String.format("%.02f", tmpTotalBonuses);
					rowArray[29] = resultSet.getString("gross_rate_sales");
					rowArray[30] = resultSet.getString("gross_rate_manager");
					rowArray[31] = resultSet.getString("gross_rate_agent");
					rowArray[35] = String.format("%.02f", tmpTotalPaidEmp);
					rowArray[36] = String.format("%.02f", tmpGross - tmpTotalPaidEmp);
			...
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[2])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[17])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[20])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[21])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[22])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[23])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[24])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[28])%></div></td>
			<% float commission  = 0.0f;%>
			<% 
					
				try{
					float gross_rate = Float.parseFloat(NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[29]));
					float gross_rate_agent = Float.parseFloat(NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[30]));
					float gross_rate_sales = Float.parseFloat(NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[31]));
					commission = (gross_rate+gross_rate_agent+gross_rate_sales) * Float.parseFloat(NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[23]));
			...
			%>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=String.format("%.02f", commission)%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[35])%></div></td>
			<td style="padding:5px;width:100px;"><div class="form-group" >
			<%=NullCheck.check(((String[])resultSetMap.get((String)resultSetVector.get(l)))[36])%></div></td>			
			</tr>				
