...
//	alert('ready to submit the form again');
	...
	function clearSearchKeys(){
		...
		//alert(urlString);
		xmlhttp.open("GET", "standard-truckboard-trucklist.shippers.jsp?origin=" + encodeURIComponent(startLoc) + urlString,true);
		xmlhttp.send();
		}
    ...
    deleteTruck('removetruck.shipper.jsp', truck_id);
	...
	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Messages <span class="caret"></span></a>
		<%}%>
				...
				<li><a href="add_truck.jsp">Add Truck</a></li>
                		<li><a href="add_shipper.jsp">Add Shipper</a></li>
					<%}%>
