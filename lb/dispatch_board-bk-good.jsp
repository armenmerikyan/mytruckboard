		...
		<%}%>
				...
				<li class="dropdown active">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Dispatch <span class="caret"></span></a>
						...
						<li class="active"><a href="dispatch_board.jsp">Dispatch Board</a></li>
						<li><a href="dispatch_customers.jsp">Customers</a></li>
						<li><a href="dispatch_shippers.jsp">Shippers</a></li>
						<li><a href="dispatch_consignees.jsp">Consignees</a></li>
...
<div class="row">
	<div class="col-sm-12" align="left">
                <div id="navbar" class="navbar-collapse collapse" align="left" style="background-color:#DEB887;color:white;" >
			<ul class="nav navbar-nav" >
			<li><a href="standard-truckboard.jsp" >Admin</a></li>
			<li><a href="truckboard.jsp">IFTA</a></li>
			<li><a href="truckboard.jsp">Accounting</a></li>
			<li><a href="truckboard.jsp">Dashboard</a></li>
			<li><a href="truckboard.jsp">Reports</a></li>
			<li><a href="truckboard.jsp">Financing</a></li>
			<li><a href="truckboard.jsp">Training</a></li>
			<li><a href="truckboard.jsp">Help</a></li>
			</ui>
		</div>
	</div>
</div>
...
<!--
	<div class="input-group input-group-sm">
			...
			<select class="form-control" name="filterfor" onChange="window.location.href=this.value">
...
<HR style="margin-bottom: 5px;margin-top: 1px;">
	...
	<button class="btn btn-default btn-sm" type="submit" onclick="location.href='new_load.jsp?cmd=newLoad&statusLD=Open'" >New Active Load</button>	
	<button class="btn btn-default btn-sm" type="submit" onclick="location.href='new_load.jsp?cmd=newLoad&statusLD=Pending'" >New Pending Load</button>
	<button class="btn btn-default btn-sm" type="submit" onclick="location.href='new_load.jsp'" >Offered Trucks</button>
	<!-- end search form -->
	</div>
	</div>
	</div>
<HR style="margin-bottom: 5px;margin-top: 5px;">
	...
	<div class="col-md-12"  align="left" >
                <div id="navbar" class="navbar-collapse collapse" align="left">
	<div class="col-md-12">
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=Pending" ><span class="glyphicon glyphicon-menu-hamburger" style="color:orange;" >Pending</span></a>&nbsp;
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=Open" ><span class="glyphicon glyphicon-menu-hamburger" style="color:red;" >Open</span></a>&nbsp;
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=Refused" ><span class="glyphicon glyphicon-menu-hamburger" style="color:purple;" >Refused</span></a>&nbsp;
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=Covered" ><span class="glyphicon glyphicon-menu-hamburger" style="color:blue;" >Covered</span></a>&nbsp;
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=Dispatched" ><span class="glyphicon glyphicon-menu-hamburger" style="color:brown;" >Dispatched</span></a>&nbsp;
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=On Route&close=true" ><span class="glyphicon glyphicon-menu-hamburger" style="color:green;" >On-Route</span></a>&nbsp;
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=Unloading" ><span class="glyphicon glyphicon-menu-hamburger" style="color:darkgrey;" >Unloading</span></a>&nbsp;
        <a href="dispatch_board.jsp?searchType=LoadStatus&searchKey=In Yard&close=true" ><span class="glyphicon glyphicon-menu-hamburger" style="color:lightCoral;" >In-Yard</span></a>&nbsp;
	</div>
	</div>		
	</div>		
	</div>	
