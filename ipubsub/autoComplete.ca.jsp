	<%@ page import="java.util.*,java.io.*,java.net.*,org.json.simple.*" %><%
        ...
        URL yahoo = new URL("https://maps.googleapis.com/maps/api/place/autocomplete/json?input=" + URLEncoder.encode(request.getParameter("location")) + "&types=address&components=country:us&location=34.1708,-118.2500&radius=500&sensor=true&key=AIzaSyA_vtLue-wqsFJ4iTpAaa8yveWU_p64Ai4");
