<%@ page import="java.util.*,java.io.*,java.net.*,org.json.simple.*" %><%
	...
	URL yahoo = new URL("https://maps.googleapis.com/maps/api/place/details/json?reference=" + request.getParameter("location") + "&sensor=true&key=AIzaSyA_vtLue-wqsFJ4iTpAaa8yveWU_p64Ai4");
