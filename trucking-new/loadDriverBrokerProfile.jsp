...
//			String url = "jdbc:sapdb://localhost/BIGDB?sqlmode=ORACLE";
		...
		Connection connection2 = DriverManager.getConnection(url,"<USERNAME>", "<PASSWORD>");
			...
			ps = connection2.prepareStatement("select * from TRUCKING_COMPANY where TRUCKING_COMPANY.isTestAccount = 0");	
...
//			ps.setString(1, emailCustomer);
			...
			ps = connection2.prepareStatement("select count(distinct(quote_id)) as quote_count from TRUCKING_EQUIPMENT LEFT JOIN trucking_quote as trk_quote ON trk_quote.equipment_id = TRUCKING_EQUIPMENT.id where TRUCKING_EQUIPMENT.driver_email = ? and trk_quote.accept_status = 'Accepted' and trk_quote.reject_status is null and trk_quote.completed_status is null and TRUCKING_EQUIPMENT.company_id = ? order by trk_quote.ts desc");	
			ps.setString(1, emailCustomer);		
