...
<section id="first" class="main">
        ...
        <div class="2u" style="height: 2px;">&nbsp;</div>
                    ...
                    <div class="row" style="margin-right: 2px;">
        <div class="2u" style="height: 2px;">&nbsp;</div>
                        <div class="8u"><input type="text" class="text" id="phone" name="phone" placeholder="Phone" value="" required /></div>
        <div class="2u" style="height: 2px;">&nbsp;</div>
                    </div>
                    ...
                    <div class="row" style="margin-right: 2px;">
        <div class="2u" style="height: 2px;">&nbsp;</div>
                        <div class="8u"><input type="text" class="text" name="email" placeholder="Email" value="" required /></div>
        <div class="2u" style="height: 2px;">&nbsp;</div>
                    </div>
                    <div class="row" style="margin-right: 2px;">
        <div class="2u" style="height: 2px;">&nbsp;</div>
                        <div class="8u"><input type="password" class="text" name="password" placeholder="Choose Password" required /></div>
        ...
        <div class="2u" style="height: 2px;">&nbsp;</div>
        		...
        		<div class="2u" style="height: 2px;">&nbsp;</div>
                        <div class="8u" > <input type="text" class="text" id="company_name" name="company_name" placeholder="Company Name" value="" required /></div>
		        <div class="2u" style="height: 2px;">&nbsp;</div>
                    </div>
