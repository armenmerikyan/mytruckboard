...
<!-- Main page: -->
    ...
    <input type='text' id='searchKey' name='searchKey' style="font-size: 14px; padding-left: 5px; width: 110px;" class="form-control" placeholder="Search Key" <%if(request.getParameter("searchKey")!=null){%> value="<%=request.getParameter("searchKey")%>"<%}%>>
...
<hr style="margin-top: 5px; margin-bottom: 5px;">
    ...
    <div id="defaultDetail" class="col-sm-4" style="max-height: 400px; padding-left: 2px; padding-right: 2px; overflow-y:auto;">
    ...
    <div id="defaultdd" style="float:right;width:100%; overflow-y:auto;"></div>
